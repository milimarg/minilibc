...
Test(my_rindex, empty_string, .init = setup, .fini = teardown) {
...
Test(my_rindex, filled_string, .init = setup, .fini = teardown) {
...
Test(my_rindex, filled_string_no_char_found, .init = setup, .fini = teardown) {
